...
import { Timestamp, addDoc, collection, doc, limit, query, updateDoc, where } from 'firebase/firestore'
...
import { getMoneyFormat } from '../../lib/helper/util'
    ...
    <div className="px-40 pb-5">
      ...
      <div className="flex pt-4">
        <div className="w-96 h-96 relative rounded mr-5">
          ...
          <Image className="relative rounded-xl " objectFit="cover" src={`${event?.image}`} alt="event-poster" layout="fill" width={150} height={200} />
        </div>
          ...
          <div className="mr-10">
            ...
            <div className="px-3 mb-5">
              ...
              <p className="flex items-center">
                <BsCalendar className="mr-2 text-gray-400" />
