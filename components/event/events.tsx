    ...
    <div className="py-5 flex flex-col gap-4">
              ...
              {!isCalendarView && (
                <div className="relative">
                  ...
                  <div
                    ...
                    } fixed z-20 top-0 left-0 w-[100vw] h-[100vh]`}
                    onClick={toggleDropdown}
                  ></div>
                  <div
                    className={`${
                      !showFilterDropdown && "hidden"
                    } absolute z-50 w-52 origin-top-right rounded-md border border-gray-100 bg-white shadow-lg`}
                  >
                    <div className="p-2">
      ...
      <div className="overflow-hidden pb-4">
        <div
          ...
          style={{
            marginTop: isCalendarView
              ? `-${listHeight.current.clientHeight + 20}px`
              : "0",
          }}
        >
          {loading ? (
        ...
        <div
          className={`transition-all mt-8 ${calendarStyle}`}
        >
